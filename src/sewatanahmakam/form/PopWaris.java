...
public class PopWaris extends javax.swing.JFrame {

    public static PopWaris obj=null;
    IdWarisController wCont=new IdWarisController(SewaTanahMakam.emf);
    DefaultTableModel model;
    FormTransaksi FT=null;
    /**
     * Creates new form PopWaris
     */
    public PopWaris() {
        initComponents();
    ...
    public void tampilTableWaris(){
        tableWaris.setModel(wCont.showPopTable(model));
    }
    
    private void cariTable(String cari){
        DefaultTableModel x=wCont.cariPop(model, cari);
        if(x.getRowCount()==0){
            JOptionPane.showMessageDialog(null, "Data tidak ditemukan!");
        }else{
            tableWaris.setModel(wCont.cariPop(model, cari));
        }
    }
    ...
    private void initComponents() {
        ...
        tableWaris.setAutoCreateRowSorter(true);
        ...
        jScrollPane1.setViewportView(tableWaris);
...
//        cariTable(txtCari.getText());
    ...
    private void btPilihActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btPilihActionPerformed
        ...
        if(baris==-1){
            ...
            FT.kdWar=tableWaris.getValueAt(baris, 0).toString();
            FT.pilihWaris();
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopWaris.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
