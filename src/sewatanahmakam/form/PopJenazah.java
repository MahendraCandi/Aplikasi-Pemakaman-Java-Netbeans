 ...
 * @author Candi-PC
 */
public class PopJenazah extends javax.swing.JFrame {

    public static PopJenazah obj=null;
    IdJenazahController jCont=new IdJenazahController(SewaTanahMakam.emf);
    DefaultTableModel model;
    FormTransaksi FT=null;
    /**
     * Creates new form PopJenazah
     */
    public PopJenazah() {
        initComponents();
    ...
    public static PopJenazah getObj(){
        if(obj==null){
            obj=new PopJenazah();
        }
        return obj;
    ...
    public void tampilTableJenazah(){
        tableJenazah.setModel(jCont.showPopTable(model));
    }
    
    private void cariTable(String cari){
        DefaultTableModel x=jCont.cariPop(model, cari);
        if(x.getRowCount()==0){
            JOptionPane.showMessageDialog(null, "Data tidak ditemukan!");
        }else{
            tableJenazah.setModel(jCont.cariPop(model, cari));
        }
    }
    ...
    private void btPilihActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btPilihActionPerformed
        ...
        if(baris==-1){
            ...
            FT.kdJen=tableJenazah.getValueAt(baris, 0).toString();
            FT.pilihJenazah();
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopJenazah.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PopJenazah().setVisible(true);
            }
        });
    }
